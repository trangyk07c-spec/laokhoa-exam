const CACHE_NAME='laokhoa-v8-1-20260818-1';
const CORE=['./','./index.html','./quiz.html','./geriatric.html','./drugs.html','./lesson.html','./app.css','./progress.js','./update.js','./quiz-v8.js','./extra-lessons.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./data/content-version.json','./data/questions.json','./data/guidelines.json','./data/scales.json','./data/drugs.json','./data/extra-lessons.json'];
